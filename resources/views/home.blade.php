    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <a class="btn text-white py-3 px-5 mt-2" style="background: var(--primary)" href="">Read More</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        <div class="col-lg-6">
                            @foreach ($breakfastFood as $breakfast) 
                                <div class="d-flex align-items-center"> 
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <small class="fst-italic">{{substr($breakfast->description,0,80)}}</small>
                                        <a type="button" href="{{ route('food.details', $breakfast->id) }}" style="background: var(--primary)" class="btn text-white py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            @foreach ($lunchFood as $lunch) 
                                <div class="d-flex align-items-center"> 
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <small class="fst-italic">{{substr($lunch->description,0,80)}}</small>
                                        <a type="button" href="{{ route('food.details', $lunch->id) }}" style="background: var(--primary)" class="btn text-white py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>         
                            ...
                            @foreach ($dinnerFood as $dinner) 
                                <div class="d-flex align-items-center"> 
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <small class="fst-italic">{{substr($dinner->description,0,80)}}</small>
                                        <a type="button" href="{{ route('food.details', $dinner->id) }}" style="background: var(--primary)" class="btn text-white py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
